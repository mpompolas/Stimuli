...
stim.probe.f1                          =   10;
stim.probe.f2                          =   20;
stim.probe.f3                          =   44; % WITH 30 IT LOSES SOME FRAMES
...
stim.Probes.x = stim.displayParams.resolutionWidthPix/2 + saccade_vector*[-1 0 1];  
stim.Probes.y = (stim.displayParams.resolutionHeightPix/2 + probes_Y_distance) * [1 1 1];    
...
photodiode_texture1      = Screen('MakeTexture',stim.displayParams.window,round(stim.probeColor/4));
photodiode_texture2      = Screen('MakeTexture',stim.displayParams.window,round(stim.probeColor/3));
photodiode_texture3      = Screen('MakeTexture',stim.displayParams.window,round(stim.probeColor/2));
photodiode_texture4      = Screen('MakeTexture',stim.displayParams.window,round(stim.probeColor/1));
